...
using PharMedTOGO.Web.PaymentIntegrations.Stripe;
using Stripe;
...
{
    private readonly StripeSettings stripeSettings = _stripeSettings.Value;
            ...
            LineItems = new List<SessionLineItemOptions>()
            {
                new SessionLineItemOptions()
                {
                    PriceData = new SessionLineItemPriceDataOptions()
                    {
                        ...
                        {
                            Name = "PharMedTOGO.Web Total checkout"
                        }
                    },
                    Quantity = 1
                }
